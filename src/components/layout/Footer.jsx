      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          ...
          <div className="md:col-span-2 space-y-6 text-left">
            <div className="flex items-center gap-3">
               ...
               <h2 className="text-2xl font-black tracking-tighter uppercase text-[var(--text-main)] italic">NovelNest</h2>
            </div>
            <p className="text-[15px] leading-relaxed max-w-sm text-[var(--text-dim)]">
              Your home for high-quality storytelling and digital books. 
              We organize and protect the world's best web novels for modern readers.
            </p>
          </div>
          ...
          <div className="text-left">
            ...
            <ul className="space-y-4">
              <li><a href="/novels" className={linkStyle}>All Novels</a></li>
              <li><a href="/rankings" className={linkStyle}>Top Ranked</a></li>
              <li><a href="/library" className={linkStyle}>My Library</a></li>
            </ul>
          </div>

          {/* Legal & Support */}
          <div className="text-left">
            <span className={headingStyle}>Information</span>
            <ul className="space-y-4">
              <li><a href="/terms" className={linkStyle}>Terms of Service</a></li>
              <li><a href="/privacy" className={linkStyle}>Privacy Policy</a></li>
              <li><a href="/safety" className={linkStyle}>User Safety</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between py-6 border-y border-[var(--border)] mb-10 gap-6">
            <div className="flex flex-wrap justify-center gap-8">
              <div className="flex items-center gap-2">
                 ...
                 <span className="text-[11px] font-bold text-[var(--text-dim)] uppercase tracking-wider">Version 0.1.0</span>
              </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-4">
            <span className="text-[11px] font-bold text-[var(--text-dim)] uppercase tracking-widest">Created By</span>
